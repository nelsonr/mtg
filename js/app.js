...
Elm.MTG = Elm.MTG || {};
Elm.MTG.make = function (_elm) {
   "use strict";
   _elm.MTG = _elm.MTG || {};
   if (_elm.MTG.values) return _elm.MTG.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   function (v) {
      return v === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v === "object" && "players" in v && "activePlayers" in v && "currentTime" in v && "timeIsRunning" in v && "gameOver" in v ? {_: {}
                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                      v.timeIsRunning)
                                                                                                                                                                                                                      ,gameOver: typeof v.gameOver === "boolean" ? v.gameOver : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                      v.gameOver)} : _U.badPort("an object with fields `players`, `activePlayers`, `currentTime`, `timeIsRunning`, `gameOver`",
      v));
   });
   ...
   var getAlivePlayers = F2(function (playersList,
   activePlayersCount) {
   ...
   var isGameOver = F2(function (playersList,activePlayersCount) {
      var alivePlayers = A2(getAlivePlayers,
      playersList,
      activePlayersCount);
      return _U.eq($List.length(alivePlayers),1);
   });
   ...
   var getNextColor = function (currentColor) {
      var colorList = _U.list(["red"
                              ...
                              ,"blue"
                              ,"white"]);
      var findNext = F2(function (list,color) {
         findNext: while (true) {
            var _p0 = list;
            if (_p0.ctor === "[]") {
                  return $Maybe.Nothing;
                  ...
                  if (_p0._1.ctor === "[]") {
                        return $List.head(colorList);
                     } else {
                        var _p1 = _p0._1;
                        if (_U.eq(_p0._0,color)) return $List.head(_p1); else {
                              var _v1 = _p1,_v2 = color;
                              list = _v1;
                              color = _v2;
                              continue findNext;
                           }
      ...
      var _p2 = A2(findNext,colorList,currentColor);
      if (_p2.ctor === "Just") {
            return _p2._0;
         } else {
            return currentColor;
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return {ctor: "_Tuple2"
         ...
         case "StartStopTimer": return {ctor: "_Tuple2"
                                       ...
                                       ,_1: $Effects.none};
         case "ResetGameOver": return {ctor: "_Tuple2"
                                      ,_0: _U.update(model,{gameOver: false,timeIsRunning: true})
                                      ,_1: $Effects.none};
         ...
         case "ResetWins": return {ctor: "_Tuple2"
                                  ...
                                  {players: A2($List.map,
                                  function (player) {
                                     return _U.update(player,{wins: 0});
                                  },
                                  model.players)})
                                  ,_1: $Effects.none};
         case "IncreasePlayers": return _U.cmp(model.activePlayers,
           5) < 0 ? {ctor: "_Tuple2"
                    ,_0: _U.update(model,{activePlayers: model.activePlayers + 1})
                    ,_1: $Effects.none} : {ctor: "_Tuple2"
                                          ,_0: model
                                          ,_1: $Effects.none};
         case "DecreasePlayers": return _U.cmp(model.activePlayers,
           2) > 0 ? {ctor: "_Tuple2"
                    ,_0: _U.update(model,{activePlayers: model.activePlayers - 1})
                    ,_1: $Effects.none} : {ctor: "_Tuple2"
                                          ,_0: model
                                          ,_1: $Effects.none};
         case "CyclePlayerColor": var changeColor = function (player) {
              return _U.eq(player.id,_p3._0) ? _U.update(player,
              {color: getNextColor(player.color)}) : player;
           };
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  {players: A2($List.map,changeColor,model.players)})
                  ,_1: $Effects.none};
         case "UpdateLife": var setLife = function (player) {
              return _U.eq(player.id,_p3._0) ? _U.update(player,
              {life: player.life + _p3._1}) : player;
           };
           var playersList = A2($List.map,setLife,model.players);
           var gameOver = A2(isGameOver,playersList,model.activePlayers);
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  {players: playersList
                  ,timeIsRunning: $Basics.not(gameOver)
                  ,gameOver: gameOver})
                  ,_1: $Effects.none};
         case "UpdateNameInput": var setNameEdit = function (player) {
              return _U.eq(player.id,_p3._0) ? _U.update(player,
              {nameEdit: _p3._1}) : player;
           };
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  {players: A2($List.map,setNameEdit,model.players)})
                  ,_1: $Effects.none};
         case "EnableNameInput": var editPlayer = function (player) {
              return _U.eq(player.id,_p3._0) ? _U.update(player,
              {edit: true}) : player;
           };
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  {players: A2($List.map,editPlayer,model.players)})
                  ,_1: $Effects.none};
         case "SaveNameInput": var setName = function (player) {
              return _U.eq(player.id,_p3._0) && !_U.eq(player.nameEdit,
              "") ? _U.update(player,
              {name: player.nameEdit,edit: false}) : player;
           };
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  {players: A2($List.map,setName,model.players)})
                  ,_1: $Effects.none};
         case "IncreaseWins": var addWin = function (player) {
              return _U.eq(player.id,_p3._0) ? _U.update(player,
   ...
   var IncreaseWins = function (a) {
      return {ctor: "IncreaseWins",_0: a};
   };
   var SaveNameInput = function (a) {
      return {ctor: "SaveNameInput",_0: a};
   };
   var UpdateNameInput = F2(function (a,b) {
      return {ctor: "UpdateNameInput",_0: a,_1: b};
   });
   var EnableNameInput = function (a) {
   ...
   var nameContainer = F2(function (address,player) {
      ...
      _U.list([A2($Html.input,
              ...
              _U.list([$Html$Attributes.$class("submit")
                      ,A2($Html$Events.onClick,address,SaveNameInput(player.id))]),
              _U.list([$Html.text("Save")]))]))])) : A2($Html.div,
      _U.list([$Html$Attributes.$class("name-container")]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("name")
              ,A2($Html$Events.onClick,address,EnableNameInput(player.id))]),
      _U.list([$Html.text(player.name)]))]));
   });
   var UpdateLife = F2(function (a,b) {
      return {ctor: "UpdateLife",_0: a,_1: b};
   });
   var CyclePlayerColor = function (a) {
      return {ctor: "CyclePlayerColor",_0: a};
   };
   var playerBox = F2(function (address,player) {
      return A2($Html.div,
      _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2"
                                                   ,_0: A2($Basics._op["++"],"player ",player.color)
                                                   ,_1: true}
                                                  ,{ctor: "_Tuple2"
                                                   ,_0: "deceased"
                                                   ,_1: _U.cmp(player.life,0) < 1}]))]),
      _U.list([A2(nameContainer,address,player)
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("life-container")
                      ,A2($Html$Events.onClick,address,CyclePlayerColor(player.id))]),
              _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("options-row")]),
                      _U.list([A2($Html.div,
                              _U.list([$Html$Attributes.$class("option")
                                      ,A2($Html$Events.onClick,address,A2(UpdateLife,player.id,1))]),
                              _U.list([A2($Html.button,
                              _U.list([]),
                              _U.list([$Html.text("+1")]))]))
                              ,A2($Html.div,
                              _U.list([$Html$Attributes.$class("option")
                                      ,A2($Html$Events.onClick,address,A2(UpdateLife,player.id,5))]),
                              _U.list([A2($Html.button,
                              _U.list([]),
                              _U.list([$Html.text("+5")]))]))]))
                      ,A2($Html.div,
   ...
   var playersContainer = F2(function (address,players) {
      var playersCount = $List.length(players);
      var playersList = A2($List.map,playerBox(address),players);
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("overflow-container")]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class(A2($Basics._op["++"],
      "players-container players-",
      $Basics.toString(playersCount)))]),
      playersList)]));
   });
   var DecreasePlayers = {ctor: "DecreasePlayers"};
   var IncreasePlayers = {ctor: "IncreasePlayers"};
   var ResetWins = {ctor: "ResetWins"};
   var ResetGame = {ctor: "ResetGame"};
   var ResetGameOver = {ctor: "ResetGameOver"};
   var victoryMessageContainer = F2(function (address,player) {
      ...
      _U.list([A2($Html.h1,
              ...
              _U.list([A2($Html.button,
                      ...
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.$class("option btn-sm")
                              ,A2($Html$Events.onClick,address,ResetGameOver)]),
   ...
   var gameOptionsContainer = F2(function (address,model) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.button,
                      _U.list([$Html$Attributes.$class("option")
                              ,$Html$Attributes.disabled(_U.eq(model.activePlayers,2))
                              ,A2($Html$Events.onClick,address,DecreasePlayers)]),
                      _U.list([$Html.text("Remove Player")]))
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.$class("option")
                              ,$Html$Attributes.disabled(_U.eq(model.activePlayers,5))
                              ,A2($Html$Events.onClick,address,IncreasePlayers)]),
                      _U.list([$Html.text("Add Player")]))]))]));
   });
   var gameOverView = F2(function (address,model) {
      var alivePlayers = A2(getAlivePlayers,
      model.players,
      model.activePlayers);
      var victoryMessageView = A2($List.map,
      victoryMessageContainer(address),
      alivePlayers);
      return A2($Html.div,
      ...
      _U.list([A2($Html.div,
              ...
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("victory-container")]),
              victoryMessageView)]));
   });
   ...
   var view = F2(function (address,model) {
      return model.gameOver ? A2(gameOverView,
      address,
      model) : A2(defaultView,address,model);
   });
   ...
   return _elm.MTG.values = {_op: _op
                            ...
                            ,CyclePlayerColor: CyclePlayerColor
                            ,UpdateLife: UpdateLife
                            ,EnableNameInput: EnableNameInput
