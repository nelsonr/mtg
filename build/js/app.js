...
Elm.MTG.make = function (_elm) {
   ...
   function (v) {
      return v === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v === "object" && "players" in v && "activePlayers" in v ? {_: {}
                                                                                                                                                     ,players: typeof v.players === "object" && v.players instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.players.map(function (v) {
                                                                                                                                                        return typeof v === "object" && "id" in v && "name" in v && "color" in v && "life" in v && "edit" in v && "nameEdit" in v ? {_: {}
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    v.nameEdit)} : _U.badPort("an object with fields `id`, `name`, `color`, `life`, `edit`, `nameEdit`",
                                                                                                                                                        v);
                                                                                                                                                     })) : _U.badPort("an array",
                                                                                                                                                     v.players)
      ...
      {case "NoOp": return {ctor: "_Tuple2"
         ...
         case "EnableNameInput": var editPlayer = function (player) {
           ...
           return {ctor: "_Tuple2"
                  ...
                  ,_1: $Effects.none};
         default: var setName = function (player) {
   ...
   var gameOptionsContainer = F2(function (address,model) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.button,
              _U.list([$Html$Attributes.$class("option-reset")
   ...
   var Player = F6(function (a,b,c,d,e,f) {
      return {id: a,name: b,color: c,life: d,edit: e,nameEdit: f};
   });
